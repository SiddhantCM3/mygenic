...
if(isset($_POST['submit'])){
    ...
    if($Product_Name=='' or $Product_Chemical=='' or $Product_Form=='' or $Company_Name=='' or $Product_Storage=='' or $Product_Packing=='' or  $Product_Category=='' or $product_image==''){
        ...
        // Insert Query
        $insert_products = "insert into `product` (Product_Name, Product_Image, Product_Chemical, Product_Form, Company_Name, Product_Storage, Product_Packing, Product_Category, Parent_Id) values ('$Product_Name', '$product_image', '$Product_Chemical', '$Product_Form', '$Company_Name', '$Product_Storage', '$Product_Packing', '$Product_Category', $Parent_Id)";
