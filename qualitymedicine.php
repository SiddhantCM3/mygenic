...
<section id="quality-medicine-supplier" class="section-bg service">
   <div class="section-head">
    ...
    <div class="container pt-5">
        <div class="row">            
            <div class="col-lg-6 col-md-6 col-sm-12 intro-text">
                <h3 data-aos="fade-up" data-aos-delay="500">Crisis Supplies for COVID-19</h3>                
                <p data-aos="fade-up" data-aos-delay="500">The COVID-19 pandemic has created an unprecedented demand for medical supplies, including personal protective equipment (PPE) and medical devices such as ventilators. To help address the crisis, Mygenic Healthcare Private Limited, have shifted their focus towards manufacturing and supplying critical medical supplies for COVID-19.</p>

                <p data-aos="fade-up" data-aos-delay="500">Mygenic Healthcare Private Limited has been working tirelessly to produce and supply a range of medical supplies needed for COVID-19, such as face masks, hand sanitizers, and other PPE. They have also been involved in the production and supply of medical devices such as ventilators, which are crucial for the treatment of severe cases of COVID-19.</p>
